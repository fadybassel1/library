            ...
            <div class="container-fluid">
                <div style="text-align: center" class="alert alert-info" role="alert">
                    ...
                    <div style="float: right" class="custom-control custom-radio custom-control-inline">
                        <input @if($reader->service==1) checked @endif onclick="servicee()" type="radio" value="1" class="custom-control-input" id="defaultInline1" name="service">
                        <label class="custom-control-label"  for="defaultInline1">يوجد خدمة</label>
                      </div>
                      <div style="float: right" class="custom-control custom-radio custom-control-inline">
                        <input @if($reader->service==0) checked @endif onclick="noservice()"  type="radio" value="0" class="custom-control-input" id="defaultInline2" name="service">
                            ...
                            <div class="card card-stats mb-4 mb-xl-0">
                                <div class="card-body">
                                    ...
                                    <div style="text-align: center">
                                        ...
                                        <input id="churchlocation"
                                            value="{{$reader->churchlocation ?? "unknown" }}"
                                        ...
                                        <input id="churchcountry"
                                            value="{{$reader->churchcountry ?? "unknown"}}" name="churchcountry"
                                            type="text"
                            ...
                            <div class="card card-stats mb-4 mb-xl-0">
                                <div class="card-body">
                                    ...
                                    <div style="text-align: center">
                                        ...
                                        <input id="country" value="{{$reader->country ?? "unknown" }}" name="country"
                                        ...
                                        <input id="city" value="{{$reader->city ?? "unknown" }}" name="city" type="text"
                        ...
                        <div id="third"  class="{{$row}}">
                            <div class="card card-stats mb-4 mb-xl-0">
                                <div class="card-body">
                                    ...
                                    <select onchange="changetype(this.value)" name="type" class="browser-default custom-select">
                                        @if ($reader->type==0)
                                    ...
                                    <div id="work" style="display: none">
                                        ...
                                        <div style="text-align: center">
                                            ...
                                            <input type="text" value="{{$reader->degree ?? "unknown" }}" name="degree" class="form-control @error('degree') is-invalid @enderror">
                                            @error('degree')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                            
                                            <p class="alert alert-info">الوظيفة</p>
                                            <input type="text" value="{{$reader->job ?? "unknown" }}" name="job" class="form-control @error('job') is-invalid @enderror">
                                            @error('degree')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                            ...
                                            <input type="text" value="{{$reader->company ?? "unknown" }}" name="company" class="form-control @error('company') is-invalid @enderror">
                                            @error('company')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
                        ...
                        <div id="service" class="{{$row}}">
                            ...
                            <div class="card card-stats mb-4 mb-xl-0">
                                <div class="card-body">
                                    ...
                                    <input type="text" value="{{$reader->servicename}}" name="servicename" class="form-control" >
                                        <p class="alert alert-info">الكنيسة</p>
                                    <input type="text" value="{{$reader->servicechurch}}" name="servicechurch" class="form-control">
                                    </div>
                                </div>
                            </div>
                        </div>
